...
const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  ...
  [Role.MANAGER]: [
    // Can manage all posts and assigned profiles only, view queue stats
    Permission.VIEW_USERS,
    Permission.MANAGE_ALL_POSTS,
    Permission.VIEW_ALL_POSTS,
    Permission.MANAGE_OWN_PROFILES, // Can manage profiles assigned to them
    Permission.VIEW_OWN_PROFILES, // Can view profiles assigned to them
    Permission.VIEW_QUEUE_STATS,
  ],
